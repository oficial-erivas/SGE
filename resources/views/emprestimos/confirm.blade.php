...
<html lang="en">
  ...
  <body>
    ...
    <div class="container py-4">
      <form
        action="{{ route('devolver_emprestimo', ['id' => $emprestimo->id]) }}"
        method="POST"
      >
        @csrf
        <h3 class="text-center">Devolver Equipamento</h3>
        <div class="form-group">
          <label for=""
            >Tem certeza que deseja devolver esse equipamento?</label
          >
          <br />
          <input
            type="text"
    ...
    <footer class="text-center text-white" style="background-color: #caced1">
      ...
      <div>
        ...
        <section class="">
          ...
          />
          <a href="#!">
            <div style="background-color: rgba(251, 251, 251, 0.2)"></div>
          </a>
        </section>
      </div>
      <!-- Copyright -->
      <div class="text-center p-3" style="background-color: #0000cd">
        © 2022 Copyright:
        <a class="text-white" href="https://mdbootstrap.com/">SGEH Inc.</a>
      </div>
      <!-- Copyright -->
    </footer>
