...
<html lang="pt">
  ...
  <body>
    ...
    <div class="container py-4">
      ...
      <form action="{{ route('alterar_colaborador', ['id'=>$colaborador->id]) }}" method="POST">
  @csrf
  <div class="form-group">
    <label for="">Matricula</label> <br />
    <input type="text" name="matricula" class="form-control" value="{{ $colaborador->colab_matricula }}"> <br />
</div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="setor" class="form-control" value="{{ $colaborador->colab_setor }}"> <br />
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
            ...
            <input type="text" name="email" class="form-control" value="{{ $colaborador->colab_email }}"> <br />
        </div>
