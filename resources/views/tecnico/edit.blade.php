...
<html lang="pt">
  ...
  <body>
    ...
    <div class="container py-4">
      ...
      <form action="{{ route('alterar_tecnico', ['id'=>$tecnico->id]) }}" method="POST">
  @csrf

  <div class="form-group">
    <label for="">Matricula</label> <br />
    <input type="text" name="matricula" class="form-control" value="{{ $tecnico->tec_matricula }}"> <br/>
</div>
  ...
  <div class="form-group">
    ...
    <input type="text" name="setor" class="form-control" value="{{ $tecnico->tec_setor }}"> <br />
  </div>
  ...
  <div class="form-group">
            ...
            <input type="text" name="email" class="form-control" value="{{ $tecnico->tec_email }}"><br/>
        </div>

        <div class="form-group">
            <label>Atribuição</label><br>
            <input type="text" name="atrib" class="form-control" value="{{ $tecnico->tec_atrib }}">
        </div>
