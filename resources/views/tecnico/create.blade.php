...
<html lang="pt">
  ...
  <body>
    ...
    <div class="container py-4">
      <div class="row">
        <h3>Cadastrar Tecnico</h3>
      </div>
      <form action="{{ route('registrar_tecnico') }}" method="POST">
  @csrf
        <div class="form-group">
    <label for="">Matricula</label> <br />
    <input name="matricula" class="form-control"><br/>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="form-group">
    <label for="">Atribuição</label> <br />
    <input type="text" name="atrib" class="form-control"> <br />
  </div>
  <div class="form-group">
  </div>
